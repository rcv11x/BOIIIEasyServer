...
:: Choose a path where you want to install boiii server | Example: C:\Users\Alex\Desktop\server
...
if not defined SteamcmdInstallPath (
	...
	echo //  Now you can open steamcmd.exe from: %SteamcmdInstallPath%\steamcmd\steamcmd.exe
	echo //
	echo /////////////////////////////////////////////////////////////////////////////////////////////////
	cd %CurrentPath%
	pause
